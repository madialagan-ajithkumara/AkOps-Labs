export const siteConfig = {
  name: "AkOps Labs",
  tagline: "Learn. Practice. Build. Get Hired.",
  url: "https://akopslabs.com",
  description:
    "AkOps Labs is a hands-on DevOps, Platform Engineering, AIOps, FinOps, Cloud, and Kubernetes learning platform — with enterprise consulting, an AI resume product, and a growing community.",
...
export const playgroundGames = [
  ...
  },
  {
    ...
    description: "Type real kubectl, docker, and terraform commands to diagnose and fix a live DevOps incident.",
    icon: "TerminalSquare",
    tag: "Hands-On",
    color: "#0f172a",
    category: "kubernetes",
  ...
  },
  {
    slug: "memory-match",
    name: "Concept Match",
    description: "Flip and match DevOps terms to their correct definitions. Fewer moves, higher score.",
    icon: "LayoutGrid",
    tag: "Knowledge",
    color: "#db2777",
    category: "general",
  ...
  },
  {
    slug: "yaml-battle",
    name: "YAML Battle",
    description: "Face off against the Bug — find the broken line before it hits you back.",
    icon: "Swords",
    tag: "Battle",
    color: "#dc2626",
    category: "iac",
  },
  {
    slug: "command-ninja",
    name: "Command Ninja",
    description: "Type the correct Git, Docker, Kubernetes, or Terraform command as fast as you can.",
    icon: "Terminal",
    tag: "Typing",
    color: "#7c3aed",
    category: "general",
  ...
  },
  {
    ...
    name: "AWS Cost Detective",
    description: "Find the wasteful or misconfigured resource in a mock AWS bill.",
    icon: "Search",
    tag: "Detective",
    color: "#f59e0b",
    category: "aws",
  ...
  {
    slug: "cicd-simulator",
    name: "CI/CD Simulator",
    description: "Make the right call at each pipeline decision point — rollbacks, canaries, and more.",
    icon: "GitBranch",
    tag: "Scenario",
    color: "#0f9d58",
    category: "cicd",
  },
  {
    ...
    description: "Pick the right architecture building block for real-world scenarios.",
    icon: "LayoutGrid",
    tag: "Scenario",
    color: "#2563eb",
    category: "general",
  },
  {
    ...
    description: "Order the correct incident-response steps against the clock.",
    icon: "Siren",
    tag: "Scenario",
    color: "#dc2626",
    category: "kubernetes",
  },
  {
    ...
    name: "Kubernetes Troubleshooting Room",
    description: "A real, sandboxed cluster to debug live.",
    icon: "Boxes",
    tag: "Coming Soon",
    color: "#94a3b8",
    category: "kubernetes",
  },
  {
    ...
    description: "Live AI-powered mock interviews for DevOps roles.",
    icon: "MessagesSquare",
    tag: "Coming Soon",
    color: "#94a3b8",
    category: "general",
